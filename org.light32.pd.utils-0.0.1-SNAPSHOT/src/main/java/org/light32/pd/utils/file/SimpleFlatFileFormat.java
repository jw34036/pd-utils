 ...
 */
public final class SimpleFlatFileFormat extends FlatFileFormat {


    @Override
    public Function<byte[], Map<String, String>> recordParser() {
        return (l) -> {
    ...
    @Override
    public Function<Map<String, String>, byte[]> recordBuilder() {
        return (rec) -> {
